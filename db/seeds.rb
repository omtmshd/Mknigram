...
if Rails.env == 'development'
  ...
  categories=[
    {level1:"野菜料理",level1_children:[
                                    ...
                                    {level2:"旬野菜　春",level2_children:["たけのこ","アスパラガス","山菜","クレソン","グリンピース","さやえんどう","そら豆","新たまねぎ","新じゃがいも","アボカド","レタス","菜の花","スナップエンドウ","ふき"]},
                                    {level2:"旬野菜　夏",level2_children:["とうもろこし","きゅうり","ピーマン","さやいんげん","オクラ","枝豆","ゴーヤ","ズッキーニ","冬瓜","トマト","モロヘイヤ","なす","かぼちゃ","みょうが","パプリカ","ししとう","新生姜"]},
                                    {level2:"旬野菜　秋・冬",level2_children:["大根","白菜","水菜","里芋","さつまいも","長芋・山芋","れんこん","ブロッコリー","チンゲン菜","セロリ","かぶ", "小松菜","ごぼう","カリフラワー","長ねぎ","ほうれん草","春菊"]},
                                    {level2:"きのこ",level2_children:["しいたけ","しめじ","まいたけ","エノキ","マッシュルーム","エリンギ","なめこ"]},
                                    {level2:"豆類",level2_children:["ミックスビーンズ","黒豆","ひよこ豆","大豆","レンズ豆"]},
                                    {level2:"脇役野菜",level2_children:["にんにくの芽","ラディッシュ","もやし","ヤーコン","むかご","ニラ","小ねぎ葉ねぎ","芽キャベツ","大葉"]}
                                    ]
    },
    {level1:"肉料理",level1_children:[
                                    ...
                                    {level2:"鶏肉",level2_children:["鶏の唐揚げ","ローストチキン","照り焼きチキン","鶏もも肉","鶏むね肉","鶏ささみ","鶏手羽"]},
                                    {level2:"挽き肉",level2_children:["つくね", "ハンバーグ","餃子・シュウマイ","豚まん・肉まん","牛挽き肉","豚挽き肉","あい挽き肉","鶏挽き肉","ロールキャベツ","春巻き"]},
                                    {level2:"ソーセージ",level2_children:["手作りソーセージ","ソーセージを使った料理"]},
                                    {level2:"ハム",level2_children:["手作り自家製ハム","ハムを使った料理"]},
    ...
    {level1:"ごはんもの",level1_children:[
                                    {level2:"丼もの",level2_children:["カツ丼","天丼","牛丼","中華丼","親子丼","海鮮丼","アレンジ丼"]},
                                    {level2:"カレー",level2_children:["チキンカレー","ポークカレー","野菜カレー","ビーフカレー","タイ風カレー","挽き肉を使ったカレー","インド風カレー","ルウから作るカレー","ドライカレー","スープカレー"]},
                                    ...
                                    {level2:"炒めご飯・チャーハン",level2_children:["あんかけチャーハン","海鮮チャーハン","お漬物を使ったチャーハン","納豆チャーハン","アレンジ炒めご飯","ナシゴレン"]},
                                    {level2: "炊き込み・まぜご飯",level2_children:["炊き込みご飯","まぜご飯","おこわ","ピラフ","パエリア","ビビンバ"]},
                                    {level2:"リゾット・雑炊類",level2_children:["リゾット","雑炊・おじや","お粥","クッパ"]},
                                    {level2:"アレンジごはん",level2_children:["おにぎり","焼きおにぎり","ドリア","ライスコロッケ","お茶漬け"]}
                                    ]
    },
    {level1:"パスタ・グラタン",level1_children:[
                                    {level2:"トマト系パスタ",level2_children:["ペスカトーレ","ミートソース","トマトクリーム","ボンゴレ・ロッソ","ナポリタン","アラビアータ","トマトソースパスタ"]},
                                    {level2:"クリーム系パスタ",level2_children:["クリームソース","カルボナーラ"]},
                                    ...
                                    {level2:"冷製・アイデアパスタ",level2_children:["冷製パスタ","アイデアパスタ"]},
                                    {level2:"スープパスタ"},
                                    {level2:"ニョッキ"},
                                    {level2:"グラタン",level2_children:["カボチャグラタン","マカロニグラタン","魚介のグラタン","チキングラタン","豆腐グラタン","アレンジグラタン","ポテトグラタン"]},
                                    {level2:"ラザニア・ラビオリ",level2_children:["ラザニア","ラビオリ","アイデアラザニア・ラビオリ"]},
                                    {level2:"手作りパスタ"}
                                    ]
    },
    {level1:"麺",level1_children:[
                                    {level2:"うどん",level2_children:["サラダうどん","煮込みうどん","カレーうどん","焼うどん","ほうとう","アレンジうどん","冷やしうどん"]},
                                    {level2:"蕎麦",level2_children:["温かい蕎麦","冷たい蕎麦","蕎麦寿司","アレンジ蕎麦"]},
                                    {level2:"そうめん",level2_children:["そうめんチャンプルー","にゅうめん","アレンジそうめん"]},
                                    {level2:"中華麺",level2_children:["焼きそば","ラーメン","アレンジ焼きそば","ジャージャー麺","冷やし中華"]},
    ...
    {level1:"汁物・スープ",level1_children:[
                                    ...
                                    {level2:"豚汁"},
                                    {level2:"中華スープ"},
                                    {level2:"シチュー",level2_children:["ビーフシチュー","クリームシチュー","アレンジシチュー"]},
                                    {level2:"クリームスープ"},
                                    {level2:"トマトスープ"},
                                    {level2:"コーンスープ"},
                                    {level2:"チャウダー"},
    ...
    {level1:"鍋料理",level1_children:[
                                    ...
                                    {level2:"チゲ鍋・キムチ鍋"},
                                    {level2:"みぞれ鍋(雪見鍋)"},
                                    {level2:"郷土鍋",level2_children:["石狩鍋","きりたんぽ鍋","水吹き"]},
                                    {level2:"アイデア鍋",level2_children:["蒸し鍋","トマト鍋","カレー鍋","その他アイデア鍋"]},
                                    {level2:"しゃぶしゃぶ"}
                                    ]
    },
    {level1:"粉もの",level1_children:[
                                    {level2:"たこ焼き"},
                                    {level2:"チヂミ"},
                                    {level2:"お好み焼き",level2_children:["広島風お好み焼き","関西風お好み焼き","アレンジお好み焼き"]}
                                    ]
    },
    ...
    {level1:"海藻・乾物・こんにゃく",level1_children:[
                                    {level2:"こんにゃく"},
                                    {level2:"糸こんにゃく・しらたき"},
                                    {level2:"海藻",level2_children:["わかめ","昆布","ひじき","めかぶ"]},
...
categories.each.with_index(1) do |category,i|
  ...
  level1_val= Category.create(name:"#{category[:level1]}")                          #1階層の値作成
  ...
  category[:level1_children].each.with_index(1) do |level1_child,j|
    ...
    if  level1_child[:level2_children] != nil                                     #3階層の値がある場合
